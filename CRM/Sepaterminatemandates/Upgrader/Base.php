 ...
 */
class CRM_Sepaterminatemandates_Upgrader_Base {

  /**
   * @var CRM_Sepaterminatemandates_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_Sepaterminatemandates_Upgrader(
        'org.project60.sepaterminatemandates',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_Sepaterminatemandates_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Sepaterminatemandates_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
